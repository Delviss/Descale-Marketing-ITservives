  ...
  return (
    <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          Without finding clients. Without handling contracts. Without running a business.
          You build the products. We build the business around them.
        </motion.p>
        ...
        >
          {[
            { stat: '0', label: 'Clients to chase' },
            { stat: '100%', label: 'Focus on building' },
            { stat: 'Remote', label: 'Work from anywhere' },
            { stat: 'Yours', label: 'Real ownership' },
          ].map((s) => (
