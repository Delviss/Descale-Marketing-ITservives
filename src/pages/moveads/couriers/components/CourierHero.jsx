...
const CourierHero = ({ onApply, onSeePayment }) => {
  return (
    <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          Join Descale MoveAds and earn additional income by carrying approved local campaigns on eligible
          delivery bags during your active shifts.
        </motion.p>
